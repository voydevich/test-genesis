                ...
                <div className="container">
                    <div className="row">
                                            ...
                                            <form action="">
                                                ...
                                                <div className="textarea-count-wrap">
                                                    <div className="checkbox-wrap">
                                                        <label><span></span>Press Enter to send</label>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div className="col-3" style={{
                            ...
                            {/*viewBox="0 0 195.60606384277344 50" version="1.1" preserveAspectRatio="xMidYMid meet"*/}
                            {/*style="width: 100%; padding: 5px">*/}
                            {/*<desc>Created with Sketch.</desc>*/}
                            {/*<defs>*/}
                            {/*<linearGradient x1="115.64738%" y1="-16.611735%" x2="-28.6621094%" y2="129.600016%"*/}
